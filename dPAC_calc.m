function [] = dPAC_calc(EEG,chan_fP,chan_fA,epochs,fPstart,fPend,fPstep,fPfiltband,fAstart,fAend,fAstep,fAfiltband,dirOut,type,Nboot,pdPAC,artifacts,plotWithMask,plotWithoutMask)
    ...
    [ID] = findPreviousVersion(dirOut,'dPAC');
    ...
    save([dirOut 'v' ID '_dPAC_config.mat'],'config')
