...
function [] = eMI_calc(EEG,chan_fP,chan_fA,epochs,fPstart,fPend,fPstep,fPband,fAstart,fAend,fAstep,dirOut,type,nbCycles,nbBins,w,Athresh,Nboot,pPhaseCom,peMI,artifacts,plotWithMask,plotWithoutMask)
    ...
    LimitAmp         = Athresh*mean(std(EEG.data(chan_fP,:,Epochs),0,2));
    [Maxes, LowFreq] = findMaxes_Filtration(EEG,chan_fP,fP_bins,LimitAmp,order);
